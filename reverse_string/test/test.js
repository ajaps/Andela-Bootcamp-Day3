// Test Suites for Reverse String function
  'use strict';
const myApp = require('../app/index.js');
let reverseString = myApp.reverseString;

describe("Case for an invalid input", function() {
  it("should return Invalid Input for integer values", function() {
      expect(reverseString(123)).toEqual('Invalid Input');
    });
  it("should return Invalid Input for array", function() {
      expect(reverseString(['a','b'])).toEqual('Invalid Input');
  });
  it("should return Invalid Input for an object", function() {
      expect(reverseString({food:'rice',quantity:'20kg'})).toEqual('Invalid Input');
  });
});
